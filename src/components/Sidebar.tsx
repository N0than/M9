...
import { Home, BarChart2, Italic as Crystal, Users, Trophy, Settings, HelpCircle, Shield } from 'lucide-react';
...
const menuItems = [
  ...
  { icon: Shield, label: 'Administration', path: '/admin/tv', isAdmin: true },
];
